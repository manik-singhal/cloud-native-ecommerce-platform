...
generate-kubernetes-manifests:
	...
	helm repo update
	echo "# Copyright The OpenTelemetry Authors" > kubernetes/manifests/opentelemetry-demo.yaml
	echo "# SPDX-License-Identifier: Apache-2.0" >> kubernetes/manifests/opentelemetry-demo.yaml
	echo "# This file is generated by 'make generate-kubernetes-manifests'" >> kubernetes/manifests/opentelemetry-demo.yaml
	echo "---" >> kubernetes/manifests/opentelemetry-demo.yaml
	echo "apiVersion: v1" >> kubernetes/manifests/opentelemetry-demo.yaml
	echo "kind: Namespace" >> kubernetes/manifests/opentelemetry-demo.yaml
	echo "metadata:" >> kubernetes/manifests/opentelemetry-demo.yaml
	echo "  name: otel-demo" >> kubernetes/manifests/opentelemetry-demo.yaml
	helm template opentelemetry-demo open-telemetry/opentelemetry-demo --namespace otel-demo | sed '/helm.sh\/chart\:/d' | sed '/helm.sh\/hook/d' | sed '/managed-by\: Helm/d' >> kubernetes/manifests/opentelemetry-demo.yaml
